...
const GraphicDesign = () => {
  return (
    <ProjectGallery
      ...
      description="A collection of campaign graphics, promotional materials, social media assets, posters, and brand-oriented visual content created for different digital audiences."
      tags={[
        "Campaign graphics",
        "Social content",
        "Promotional design",
      ...
      kind="design"
      buildLink={(itemId) =>
        `https://drive.google.com/open?id=${itemId}&usp=drive_copy`
      }
    />
  );
};
